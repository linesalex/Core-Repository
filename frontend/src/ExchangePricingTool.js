...
${pricingDisclaimer}`;
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Typography variant="body2" color="text.secondary" gutterBottom sx={{ mb: 3, fontSize: '0.75rem' }}>
            ...
            <Card>
              ...
              <CardContent>
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">Customer Name</Typography>
                    <Typography variant="body1" sx={{ fontSize: '0.875rem' }}>{results.customer_name}</Typography>
                  </Grid>

                  <Grid item xs={12}>
                    <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">Feed (Exchange Name - Feed Name)</Typography>
                  ...
                  <Grid item xs={12}>
                    <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">Feed NRC</Typography>
                    <Typography variant="body1" sx={{ fontSize: '0.875rem' }}>
                  ...
                  <Grid item xs={12}>
                    <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">Desired Sell Price</Typography>
                    <Typography variant="body1" sx={{ fontSize: '0.875rem' }}>
                  ...
                  <Grid item xs={12}>
                    <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">Pass Through Fees</Typography>
                    <Typography variant="body1" sx={{ fontSize: '0.875rem' }}>
                  ...
                  <Grid item xs={12}>
                    <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">ISF A</Typography>
                    <Typography variant="body1" sx={{ fontSize: '0.875rem' }}>{results.isf_a || 'Not specified'}</Typography>
                  </Grid>

                  <Grid item xs={12}>
                    <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">ISF B</Typography>
                    <Typography variant="body1" sx={{ fontSize: '0.875rem' }}>{results.isf_b || 'Not specified'}</Typography>
                  </Grid>

                  <Grid item xs={12}>
                    <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">Bandwidth</Typography>
                    <Typography variant="body1" sx={{ fontSize: '0.875rem' }}>{results.bandwidth || 'Not specified'}</Typography>
                  </Grid>

                  {results.order_entry_required && (
                    <Grid item xs={12}>
                      <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">Order Entry NRC</Typography>
                      <Typography variant="body1" sx={{ fontSize: '0.875rem' }}>
                  ...
                  {results.order_entry_required && (
                    <>
                      <Grid item xs={12}>
                        <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">Order Entry Cost</Typography>
                        <Typography variant="body1" sx={{ fontSize: '0.875rem' }}>
                      ...
                      <Grid item xs={12}>
                        <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">Order Entry ISF</Typography>
                  ...
                  <Grid item xs={12}>
                    <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">Delivery Datacenter</Typography>
